...
// Ordered so company/dev packages lead; the two crypto training tiers sit
// last — still bookable, no longer the headline. "Most Popular" now marks
...
const plans = [
  {
    ...
    cta: "Order Now",
    note: "Most popular — includes domain setup & hosting guidance",
  },
  {
    id: "ai",
    icon: Cpu,
  ...
  },
  {
    ...
    cta: "Join Now",
    note: "Includes live trading sessions",
  },
];
